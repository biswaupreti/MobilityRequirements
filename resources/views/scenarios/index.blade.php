...
@section('content')
    ...
    <div class="row">
        <div class="col-md-10">
            <h3>Scenarios for <span class="info-text-color">{{ $project->title }}</span></h3>
        </div>
        <div class="col-md-2">
            <a href="{{ url('/scenarios/create?project='. $project_id) }}" class="btn btn-primary"  style=" margin-top: 20px; color: #ffffff;">Create New</a>
        </div>
    </div>
